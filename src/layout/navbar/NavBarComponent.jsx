...
function NavBarComponent() {
  return (
    <div className=' text-xl flex flex-col gap-4 border-[1px] border-slate-600 px-2 py-4 rounded-full '>
      ...
      <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/">
       <span className='absolute py-[0.20rem] text-sm font-semibold text-white rounded-md bg-gray-800 w-[5rem] text-center  right-10  title_home'>Home
        ...
        <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/about">
        ...
        <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/skills">
        ...
        <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/services">
        ...
        <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/portfolio">
        ...
        <NavLink style={({ isActive }) => ({ color: isActive ? '#10b981' : '' })} className='relative flex items-center no-underline text-slate-600 hover:text-emerald-500 icone_home' data-hover='hello' to="/contact">
